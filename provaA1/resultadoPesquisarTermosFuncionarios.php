...
<?php
      ...
      $funItemPesquisa = $_POST["funItemPesquisa"];
      $funTermoPesquisa = $_POST["funTermoPesquisa"];
      
      
      $funItemPesquisa = trim($funItemPesquisa);
      
      $sqlFuncionario = mysqli_query($conexao,"SELECT * FROM funcionario WHERE ".$funItemPesquisa." LIKE '%".$funTermoPesquisa."%'"
...
?>
        <table class="striped">
        <tr>
            <td colspan="15"><div align="center"><font face="Arial" size="2"><b>Funcionários Pesquisados</font></b></font></div>
            </td>
        <tr>
